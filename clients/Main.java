...
import clients.cashier.ImprovedCashierModel;
...
class Main
{
  ...
  public void begin()
  {
    ...
    //THIS IS THE START OF MY SIMPLE CODE DEVELOPMENT TASK FOR MY OO ASSIGMENT 
    
    
    String filepath = "Club main music.wav";
  ...
  public void startCashierGUI_MVC(MiddleFactory mlf )
  {
    ...
    //CashierModel model      = new CashierModel(mlf);   old basket
    
    
    
    CashierModel model = new ImprovedCashierModel(mlf);   //implementation of better basket class.
